<template>
  <div class="customer-wrap main">
    <div class="page-top flex">
      ...
      <el-button type="primary" @click="chgShowAdd(true)">新增档案</el-button>
    </div>

    <el-table :data="customerData" style="width: 100%" border header-cell-class-name="t-head-cell">
  ...
  <el-dialog v-model="showAdd" title="新增档案" width="666px">
...
const rules = reactive({
  name: [{ required: true, message: '请输入档案名称', trigger: ['blur', 'change'] }]
})
function onSumbit() {
