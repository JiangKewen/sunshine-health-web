<template>
  <div class="user-wrap main">
    <div class="page-top flex">
      ...
      <el-button type="primary" @click="chgShowAdd(true)">新增用户</el-button>
    </div>

    <el-table :data="userData" style="width: 100%" border header-cell-class-name="t-head-cell">
  ...
  <el-dialog v-model="showAdd" title="新增用户" width="666px">
